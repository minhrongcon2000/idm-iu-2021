...
public class Transaction2ARFFConverter {
    ...
    public static Instances convert(Instances inputData) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        loader.setSource(new File("T:\\1\\2-3\\Intro to Data Mining\\Project\\idm-iu-2021\\IDM_IU_2021\\data\\data.arff"));
        ...
        Transaction2ARFFConverter converter = new Transaction2ARFFConverter();
        Instances newData = converter.convert(cleaner.getData());
